...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/core.min.css?v=12222211222" />
    <script src="https://unpkg.com/vue/dist/vue.min.js"></script>
    <link rel="stylesheet" href="/assets/css/style.css?v=12222222222222222222222222222222222222222222222222331222222222" />
    ...
    @endif
        ...
        <script type="text/javascript" src="/assets/js/functions.min.js?v=122223211222212231213"></script>
</head>
  ...
  <div class="owerlay"></div>
    ...
    <div class="wrapper" style="    margin-bottom: 200px;">
        <header>
            ...
            <div class="signin">
              <div class="welcome">
                <div class="name-show">Добро пожаловать,<br> <a href="#">{{Auth::user()->nick}}</a></div
                  ><div class="name-edit">
    ...
    padding: 10px;">
                      ...
                      <div class="list" >
                          ...
                          <div class="difficult">
                            <img src="/assets/images/{{$hista->mode}}-mode.png" />
                          </div>
                      </div>
                      @endforeach
                      @else
    ...
    display: block;">
                      ...
                      <div class="list">
                          ...
                          <div class="difficult"><img src="/assets/images/{{$biga->mode}}-mode.png" />
                          </div>
                      </div>
...
<div class="row1" style="    height: 100%;
    ...
    margin: 0 auto;">
			<div class="container">
				...
				<div class="buttons" style="float:right">
					<a href="/support" target="_blank">Техническая поддержка</a>
    ...
    <div class="desc">Вы можете получить бесплатно 10,00 ₽ каждый день</div>
    <div class="get-m">
      @if(!Auth::guest())
