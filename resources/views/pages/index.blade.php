  ...
  <div class="owerlay"></div>
        ...
        <header>
            ...
            <div class="mob_menu_button"></div>
              ...
              <div class="mob_menu">
              	...
              	<!--<div class="auth2">
              					<span class="user"><small>Добро пожаловать, </small><br><a href="#" class="nickname" id="asas">{{Auth::user()->username}}</a></span>
              			<form style="display:none;" class="nickname_form">
              				<input type="text" class="nickname" value="{{Auth::user()->username}}">
            ...
            <div class="signin">
              <div class="welcome">
                <div class="name-show">Добро пожаловать,<br> <a href="#">{{Auth::user()->username}}</a></div
                  ><div class="name-edit">
    ...
    padding: 10px;">
                      ...
                      <div class="list" >
                          ...
                          <div class="bet">{{$hista->bet}} <i class="flaticon-ruble"></i></div>
                          <div class="profit">
                            @if($hista->profit <= 0)
                            {{$hista->profit}}
                            <i class="flaticon-ruble"></i>
    ...
    display: none;">
                      @foreach($big as $biga)
                      <div class="list">
                          <div class="player">{{$biga->username}}</div>
                          ...
                          @if(!Auth::guest())
                            ...
                            <div class="list">
                              <div class="number">
                                ...
                                <div class="player">{{$top->username}} </div>
    ...
    background: rgba(17,23,38,.7);">
                          ...
                          <div class="list">
                            <div class="number">
                              ...
                              <div class="player">{{$top1->username}} </div>
...
">
    ...
    <div class="body-modal" style="background: #272d43;">
      ...
      <div class="profile tab tab1 active">
        <h4>Добро пожаловать, <a href="#">{{Auth::user()->username}}</a></h4>
        <div class="left">
          <label>Никнейм:</label>
    ...
    ">Выйти</a>
      ...
      <div class="referrals tab tab5">
        ...
        <div class="right">
          ...
          <input type="text" value="http://triplecash.ru?r={{Auth::user()->ref_code}}" readonly />
          ...
          <div class="ya-share2" data-services="vkontakte,facebook,odnoklassniki,twitter" data-url="http://triplecash.ru?r={{Auth::user()->ref_code}}"></div>
        </div>
        <div class="clearfix"></div>
      </div>
    </div>
