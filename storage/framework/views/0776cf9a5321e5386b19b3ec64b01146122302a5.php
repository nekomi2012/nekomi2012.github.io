...
<head>
    ...
    <?php endif; ?>
        ...
        <script type="text/javascript" src="/assets/js/functions.min.js?v=12222322112222222222222222122231213"></script>
</head>
...
<body>
  <div class="owerlay"></div>
    ...
    <div class="wrapper" style="    margin-bottom: 200px;">
        <header>
            <div class="logo">
                ...
                <a href="/"><img src="https://jetcash.me/templates/frontend/default/images/logo@2x.png" width="150">
                </a>
            ...
            <div class="mob_menu_button"></div>
              ...
              <div class="mob_menu">
              	...
              	<!--<div class="auth2">
              					<span class="user"><small>Добро пожаловать, </small><br><a href="#" class="nickname" id="asas"><?php echo e(Auth::user()->username); ?></a></span>
              			<form style="display:none;" class="nickname_form">
              				<input type="text" class="nickname" value="<?php echo e(Auth::user()->username); ?>">
            ...
            <div class="signin">
              <div class="welcome">
                <div class="name-show">Добро пожаловать,<br> <a href="#"><?php echo e(Auth::user()->username); ?></a></div
                  ><div class="name-edit">
        ...
        <div class="middle">
            <div class="history">
                ...
                <div class="table-list">
                    <div class="recent-l" id="afk" data-id="h-recent-t" style="width: 95%;
    background: red;
    ...
    padding: 10px;">
                    ...
                    <div class="recent-l hide" id="afk2" data-id="h-plays-t" style="width: 95%;
    background: red;
    background: rgba(17,23,38,.7);
    float: left;
    padding: 10px;">
                      ...
                      <div class="list" >
                          ...
                          <div class="bet"><?php echo e($hista->bet); ?> <i class="flaticon-ruble"></i></div>
                          <div class="profit">
                    ...
                    <div class="recent-l hide" id="big" data-id="h-wins-t" style="width: 95%;
    background: red;
    background: rgba(17,23,38,.7);
    float: left;
    display: none;">
          ...
          <div class="wagered">
				...
				<div class="title">
				<i class="flaticon-winner"></i> Стена героев
				</div>
				<div class="cls"></div>
				</div>
                    <div class="tabs">
                    ...
                    <div class="table-h hide" data-id="w-played-top">
						<div class="f1">Место</div>
						<div class="f2">Игрок</div>
						<div class="f3">Игр сыграно</div>
						<div class="cls"></div>
					</div>
                </div>
                <div class="table-list">
                    <div class="recent-l" data-id="w-wagered-t" style="    width: 91%;
    float: right;
    padding: 18px;
    background: rgba(17,23,38,.7);">
                    ...
                    <div class="recent-l hide" data-id="w-played-t">
                        <div class="tldate today" id="afk3" style="    width: 95%;
    float: right;
    padding: 18px;
    background: rgba(17,23,38,.7);">
   ...
   <div class="footer">
	<div class="inner">
		<div class="block1">
		<div class="logo"><img src="https://jetcash.me/templates/frontend/default/images/logo-footer@2x.png" width="150"></div>
		<div class="text">Это космос детка!<br>Хочешь испытать удачу и удвоить свои средства<br>вместе с JetCash? Это шанс для тебя!</div>
		</div>
		<div class="block2">
		<div class="title">Меню</div>
		<ul class="staticUIa">
		<li><a class="about" href="javascript:aboutUI();">О нас</a></li>
		<li><a class="affilate" href="javascript:affilateUI();">Рефералы</a></li>
		<li><a href="
		/ru/support/?act=new
		">Поддержка</a></li>
		</ul>
		...
		<div class="lang-active"><span>Русский</span> <i class="flaticon-arr-down"></i></div>
		<div class="langs">
		<ul>
		...
		<div class="block4">
		<div class="invite-friend ru">
		<div class="icon"><i class="flaticon-users"></i></div>
		<div class="title">Пригласи друзей и <i>заработай больше</i> <div class="desc">Получите 10% от каждого пополнение реферала</div></div>
		<div class="cls"></div>
		</div>
		<div class="free-money">
		<div class="icon"><i class="flaticon-money"></i></div>
		<div class="title">Получить бесплатные деньги <div class="desc">Ты можешь получать 10.00 ₽ каждый день</div></div>
		<div class="cls"></div>
		</div>
		</div>
		<div class="cls"></div>
		<div class="copyright">
		<div style="position:absolute;"><a href="//www.free-kassa.ru/" target="_blank"><img src="//www.free-kassa.ru/img/fk_btn/6.png" width="95"></a></div>
		<div class="terms"><a href="javascript:terms_show();" >пользовательское соглашение</a></div>
		<div class="powered" style="margin-left:105px;">© 2017 JetCash.in<br> Все права защищены.</div>
		<div class="agree-18"><i>18+</i> Если вам нет 18 лет, немедленно покиньте сайт</div>
		</div>
		<div class="cls"></div>
		</div>
	</div>
    ...
    <div class="freemoneyUI loginUI-size">
        ...
        <div class="text">
            Для бесплатного БОНУСA, вам нужно <a href="/login">авторизоваться</a>!
        </div>
    </div>
    <?php else: ?>
    ...
    <div class="aboutUI">
        ...
        <div class="text">TRIPLECASH многоступенчетая мини игра в которой вы можете испытать свою удачу и подняться по лестницам славы. С помощью детально проработанной системы TRIPLECASH, мы разработали доказуемо честную игру, которая натянет ваши нервы в струну, но которая даст вам шанс неслыханно разбогатеть.
            <br />
            <br /> И будьте спокойны &ndash; генератор случайных чисел использует хэш напрямую из сторонних сервисов! Выигрыш предопределен, когда вы только нажимаете старт, и ваша удача - это единственное, что имеет значение. Это означает, что TRIPLECASH на 100% доказуемо честная игра. Проверьте сами!
            <br />
            <br /> Честная система TRIPLECASH использует формулу Hash = SHA256(SHA256(Number + '-' + Server Seed)). Под самой игрой находится форма для сверки хешев. Проверь и убедить, что все честно и зависит только от твоей удачи!
            <br />
            <br /> Играй в TRIPLECASH, стань богатым и говори девчонкам, что ты один из первопроходцев этой игры. Они будут впечатлены. Или проиграй все и уж постарайся объяснить это своей жене! Предпочтительно выбрать что-то среднее. Получай удовольствие!
            <br />
            <br /> Не забудь попробовать DEMO версию, она БЕСПЛАТНАЯ.
            <br />
            <h3>Контакты</h3> Остались вопросы? Свяжитесь с нами
            <br /> Email: <a href="mailto:TRIPLECASH@mail.ru">TRIPLECASH@mail.ru</a>
        </div>
    </div>
    <div class="termsUI">
        <a href="#close" class="sb-close-btn">
        ...
        <div class="text">
            <h3>1. ОБЩИЕ ПОЛОЖЕНИЯ И ТЕРМИНЫ</h3> 1.1. Данный документ является договором на использование TRIPLECASH.RU. Ниже приведены правила и условия использования Сервиса. Пожалуйста, внимательно ознакомьтесь с ними.
            <br /> 1.2. Сервисом могут пользоваться пользователи достигшие 18-ти летия.
            <br /> 1.3. Игра "TRIPLECASH.RU" - беспроигрышная онлайн игра принадлежащяя организатору и находящиейся по адресу в сети интерет http://TRIPLECASH.RU. Организатором предоставляются услуги пользователю по организацию его развлечения, досуга и отдыха.
            <br /> 1.4 Организаторы беспроигрышной онлайн игры TRIPLECASH.RU никого насильно не заставляют проводить свой досуг на этом проекте.
            <br />
...
">
    ...
    <div class="body-modal" style="background: #272d43;">
      ...
      <div class="profile tab tab1 active">
        <h4>Добро пожаловать, <a href="#"><?php echo e(Auth::user()->username); ?></a></h4>
        <div class="left">
          <label>Никнейм:</label>
          <input type="text" placeholder="<?php echo e(Auth::user()->username); ?>" readonly/>
          <div class="stat">
    ...
    ">Выйти</a>
      ...
      <div class="referrals tab tab5">
        ...
        <div class="right">
          ...
          <input type="text" value="http://triplecash.ru?r=<?php echo e(Auth::user()->ref_code); ?>" readonly />
          ...
          <div class="ya-share2" data-services="vkontakte,facebook,odnoklassniki,twitter" data-url="http://triplecash.ru?r=<?php echo e(Auth::user()->ref_code); ?>"></div>
        </div>
        <div class="clearfix"></div>
      </div>
    </div>
